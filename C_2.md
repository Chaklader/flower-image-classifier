...
- $\max(\mathbf{z}) = 3.44$
- $\mathbf{z}_{\text{shifted}} = \mathbf{z} - 3.44 = [0.00, -2.58, -6.29, -3.34, -5.30, -5.98, -3.23, -0.77, -4.57, -3.78]$

**Step 2: Apply exponential (now safe)**

- $e^{\mathbf{z}_{\text{shifted}}} = [1.000, 0.076, 0.002, 0.035, 0.005, 0.003, 0.040, 0.463, 0.010, 0.023]$

**Step 3: Normalize**

- $\sum(e^{\mathbf{z}_{\text{shifted}}}) = 1.657$
