...
in calculus. Let me explain why this is true through several different approaches.
...
The derivative tells us the rate of change at any point. Since $e^{-x}$ decreases as $x$ increases, its rate of change
is negative, explaining why we get $-e^{-x}$.
