...
softmax(zᵢ) = e^zᵢ / (e^z₁ + e^z₂ + ... + e^zₖ) = e^zᵢ / ∑ⱼ₌₁ᵏ e^zⱼ
...
For this case, we apply the quotient rule since Sᵢ is a fraction:

$$∂Sᵢ/∂zᵢ = [(∂/∂zᵢ)(e^zᵢ) · ∑e^zⱼ - e^zᵢ · (∂/∂zᵢ)(∑e^zⱼ)] / (∑e^zⱼ)²$$

The derivative of e^zᵢ with respect to $$zᵢ$$ is $$e^zᵢ$$, and $$(∂/∂zᵢ)(∑e^zⱼ)$$ is also $$e^zᵢ$$ because only the i-th
term in the sum depends on $$zᵢ$$.
...
$$∂Sᵢ/∂zⱼ = [(∂/∂zⱼ)(e^zᵢ) · ∑e^zⱼ - e^zᵢ · (∂/∂zⱼ)(∑e^zⱼ)] / (∑e^zⱼ)²$$

Since e^zᵢ doesn't depend on zⱼ when i ≠ j, $$(∂/∂zⱼ)(e^zᵢ) = 0$$. The derivative of the sum with respect to zⱼ is e^zⱼ.
...
We know that ∂L/∂Sᵢ = -yᵢ/Sᵢ.

Substituting our derivatives from before: ∂L/∂zⱼ = ∑ᵢ (-yᵢ/Sᵢ) · [(Sᵢ(1-Sᵢ)) if i=j, (-Sᵢ·Sⱼ) if i≠j]

Let's break this into two parts:

1. The i=j term: (-yⱼ/Sⱼ) · Sⱼ(1-Sⱼ) = -yⱼ(1-Sⱼ)
2. All other terms where i≠j: ∑ᵢ≠ⱼ (-yᵢ/Sᵢ) · (-Sᵢ·Sⱼ) = Sⱼ · ∑ᵢ≠ⱼ yᵢ

Combining these: ∂L/∂zⱼ = -yⱼ(1-Sⱼ) + Sⱼ · ∑ᵢ≠ⱼ yᵢ = -yⱼ + yⱼSⱼ + Sⱼ · ∑ᵢ≠ⱼ yᵢ = -yⱼ + Sⱼ(yⱼ + ∑ᵢ≠ⱼ yᵢ) = -yⱼ + Sⱼ · ∑ᵢ
yᵢ
