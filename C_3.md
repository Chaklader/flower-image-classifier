...
Gradient descent and backpropagation are foundational techniques that enable neural networks to learn from data. Let me
explain these concepts in a clear, step-by-step manner to help you develop a deep understanding of how they work
together.
...
3. **Adam** (Adaptive Moment Estimation):
    ...
    $\mathbf{m}*t = \beta_1 \mathbf{m}*{t-1} + (1-\beta_1) \mathbf{g}_t$ (first moment - momentum)
    $\mathbf{v}*t = \beta_2 \mathbf{v}*{t-1} + (1-\beta_2) \mathbf{g}_t^2$ (second moment - adaptive rates)
